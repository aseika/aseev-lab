        ...
        get
        {
            ...
            var employeeList = new List<Employee>()
            {
                new Employee
                {
                    ...
                    BirthDate = new DateTime(1979, 1, 26),
                    WorkshopId = 1,
                    Workshop = null,
                    WorkPhoneNumber = "9374587890",
                    PersonalPhoneNumber = "0987654321",
                    Address = "г.Самара, ул.Советской армии д.100",
                ...
                new Employee
                {
                    ...
                    WorkshopId = 2,
                    Workshop = null,
                    WorkPhoneNumber = "0937654461",
                    PersonalPhoneNumber = "9964566590",
                    Address = "г.Самара, ул.Пролетарская, д.106",
                    FamilyMembersCount = 3,
                    ChildrenCount = 0,
                ...
                new Employee
                {
                    Id = 2,
                    RegNumber = "1423",
                    FirstName = "Солдатенкова",
                    LastName = "Алла",
                    Patronymic = "Петровна",
                    BirthDate = new DateTime(1978, 8, 6),
                    WorkshopId = 3,
                    Workshop = null,
                    WorkPhoneNumber = "9274568890",
                    PersonalPhoneNumber = "9217656321",
                    Address = "г.Самара Московское шоссе, д.14",
                ...
                new Employee
                {
                    Id = 3,
                    RegNumber = "1243",
                    FirstName = "Андриянова",
                    LastName = "София",
                    Patronymic = "Александровая",
                    BirthDate = new DateTime(1983, 11, 18),
                    WorkshopId = 4,
                    Workshop = null,
                    WorkPhoneNumber = "9374569790",
                    PersonalPhoneNumber = "0987654321",
                    Address = "г. Самара, ул.Ленина д.19А",
                    FamilyMembersCount = 3,
                    ChildrenCount = 1,
                    MaritalStatus = "замужем",
                    EmployeePositions = new List<EmployeePosition>(),
               ...
               new Employee
                {
                    ...
                    BirthDate = new DateTime(1983, 8, 14),
                    WorkshopId = 5,
                    Workshop = null,
                    WorkPhoneNumber = "9374467750",
                    PersonalPhoneNumber = "9376654511",
                    Address = "г. Самара, ул.Вольская д.153",
                    FamilyMembersCount = 3,
                    ChildrenCount = 1,
                    MaritalStatus = "женат",
                    EmployeePositions = new List<EmployeePosition>(),
